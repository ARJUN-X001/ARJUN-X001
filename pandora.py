...
{red}
                ...
                ░░         ░   ▒      ░   ░ ░  ░ ░  ░ ░ ░ ░ ▒    ░░   ░   ░   ▒   
                 ░              ░  ░         ░    ░        ░ ░     ░           ░  ░                       
                                      \033[1;32mCoded By : ARJUN-X001
                                           V : 3.1.0
                                       Team : EIHT
                                  \033[1;33mhttps://github.com/ARJUN-X001
""")
time.sleep(0.5)
...
⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀        ⠀⠀⠀⠀⠀⠀⠀⠙⡏⠀⠻⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀
    ...
    ╚███╔███╔╝██║██║     ██║    ╚█████╔╝██║  ██║██║ ╚═╝ ██║██║ ╚═╝ ██║███████╗██║  ██║
     ╚══╝╚══╝ ╚═╝╚═╝     ╚═╝     ╚════╝ ╚═╝  ╚═╝╚═╝     ╚═╝╚═╝     ╚═╝╚══════╝╚═╝  ╚═╝
                               ...
                               \033[1;34mHey ! It's Me ARJUN-X001 !\033         
    """)
    print(info + f"Note : This tools made by ARJUN-X001, This tools is for jammering wifi like, Make the wifi connection slow.")
          ...
          `-.\         /'  _ `---'' , . ``---' _  `\         /,-'     
             ``       /     \    ,='/ \`=.    /     \       ''          
                   ...
                   |   |     /'\_\_\ | /_/_/`\     |   |                
                    \   \__, \_     `~'     _/ .__/   /            
                     `-._,-'   `-._______,-'   `-._,-'
                      HATCHER ADMIN LOGIN BY ARJUN-X001""")
